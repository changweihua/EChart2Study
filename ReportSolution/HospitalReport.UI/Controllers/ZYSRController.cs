...
{
    [GroupDescription(GroupName = "FYJKFX", Description = "住院收入分析")]
    public class ZYSRController : Controller
    {
        //
        // GET: /ZY/
        ...
        public ActionResult GetData1(DateTime dtStart, DateTime dtEnd)
        {
            ...
            var obj = new
            {
                ...
                new NameValue{ name="诊疗费用",value=1594.12 },new NameValue{ name="药品费用",value=1075.1 }
                }
            };
